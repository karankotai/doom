...
appletsRoutes.get("/type/:type", async (c) => {
  ...
  if (!["code-blocks", "slope-graph", "chess", "mcq", "fill-blanks", "venn-diagram", "highlight-text", "comparative-advantage", "ordering", "color-mixing", "map-select", "categorization-grid", "fraction-visualizer", "chart-reading", "match-pairs", "interactive-diagram", "thought-tree", "circuit-builder"].includes(type)) {
