...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-base font-bold uppercase tracking-wide ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none active:translate-y-1 active:shadow-none",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-cosmos-primary hover:brightness-105",
        destructive:
          "bg-destructive text-destructive-foreground shadow-cosmos-destructive hover:brightness-105",
        outline:
          "border-2 border-border bg-background text-foreground shadow-cosmos-secondary hover:bg-muted",
        secondary:
          "bg-accent text-accent-foreground shadow-cosmos-accent hover:brightness-105",
