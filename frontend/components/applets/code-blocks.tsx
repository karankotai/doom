...
export const SAMPLE_CODE_PUZZLES: CodeBlocksPuzzle[] = [
  {
    id: "python-image-filter",
    question: "Make darker pixels black",
    hint: "Pixels with values below 128 are considered dark.",
    language: "python",
    lines: [
      {
        lineNumber: 1,
        segments: [
          { type: "text", content: "for pixel in image:" },
        ],
      },
      {
        lineNumber: 2,
        segments: [
          ...
          { type: "slot", slotId: "s1", correctAnswerId: "ans-condition" },
          { type: "text", content: ":" },
        ],
      },
      {
        lineNumber: 3,
        segments: [
          { type: "text", content: "        pixel = " },
          { type: "slot", slotId: "s2", correctAnswerId: "ans-zero" },
        ],
      },
    ],
    answerBlocks: [
  ...
  {
    id: "js-array-sum",
    question: "Complete the array sum function",
    hint: "Initialize the total to zero, loop through each number, and accumulate.",
    language: "javascript",
    lines: [
      {
        lineNumber: 1,
        segments: [
          { type: "text", content: "function sumArray(numbers) {" },
        ],
      },
      {
        lineNumber: 2,
        segments: [
          { type: "text", content: "  let total = " },
          { type: "slot", slotId: "s1", correctAnswerId: "ans-zero" },
          { type: "text", content: ";" },
        ],
      },
      {
        ...
        segments: [
          { type: "text", content: "  " },
          { type: "slot", slotId: "s2", correctAnswerId: "ans-for-of" },
          { type: "text", content: " {" },
        ],
      },
      {
        ...
        segments: [
          ...
          { type: "slot", slotId: "s3", correctAnswerId: "ans-plus-eq" },
      ...
      {
        lineNumber: 6,
        segments: [{ type: "text", content: "  return total;" }],
      },
      {
        lineNumber: 7,
        segments: [{ type: "text", content: "}" }],
  ...
  },
  {
    ...
    question: "Reverse a list without using built-in reverse",
    hint: "Use two pointers from the start and end, swapping elements.",
    language: "python",
    lines: [
      {
        lineNumber: 1,
        segments: [
          { type: "text", content: "def reverse(lst):" },
        ],
      },
      {
        lineNumber: 2,
        segments: [
          { type: "text", content: "    left, right = 0, " },
          { type: "slot", slotId: "s1", correctAnswerId: "ans-len" },
        ],
      },
      {
        lineNumber: 3,
      ...
      },
      {
        lineNumber: 4,
        segments: [
          { type: "text", content: "        lst[left], lst[right] = lst[right], lst[left]" },
        ],
      },
      {
        lineNumber: 5,
        segments: [
          { type: "text", content: "        left += 1" },
        ],
      },
      {
        lineNumber: 6,
        segments: [
          ...
          { type: "slot", slotId: "s3", correctAnswerId: "ans-dec" },
          { type: "text", content: " 1" },
        ],
      },
    ],
